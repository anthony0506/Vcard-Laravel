                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="d-flex" style="align-items: center;">
                                        <label class="form-check form-switch form-check-solid form-switch-sm d-flex cursor-pointer" style="margin-top: 10px;">
                                            <input type="checkbox" id="enableAffiliateCheckbox" name="enable_affiliation" class="btn-switch-clipboard form-check-input"
                                        ...
                                        <div class="input-group">
                                            {{ Form::text('affiliate_copy_code', !empty($setting['affiliate_copy_code']) ? $setting['affiliate_copy_code'] : 'Please refresh to see Affiliate Code', ['class' => 'px-2 pt-0 ' . (!empty($setting['enable_affiliation']) ? 'd-block' : 'd-none'), 'id' => 'affiliate_copy_code', 'style' => 'margin-left: 20px; border: 0; width: 100%;', 'placeholder' => '', 'disabled' => 'disabled']) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
