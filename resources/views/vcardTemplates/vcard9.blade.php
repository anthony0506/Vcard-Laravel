...
<div class="container p-0">
    ...
    <div class="vcard-nine main-content w-100 mx-auto overflow-hidden content-blur collapse show allSection">
        ...
        <div class="vcard-nine__profile-details py-3 px-sm-3 px-2">
            ...
            <div class="mt-5 profile-description">
                <span class="" style="word-break: keep-all:">{!! $vcard->description !!}</span>
            </div>
                ...
                <div class="row g-3">
                    ...
                    @if($vcard->job_title)
                        <div class="col-sm-6 col-12">
                            <div class="card event-card px-3 py-4 h-100 border-0 flex-sm-row flex-column align-items-center">
                            <span class="event-icon d-flex justify-content-center align-items-center">
                                <img src="{{asset('assets/img/vcard9/job_title.png')}}" alt="job" style="width: 30px;"/>
                            </span>
                                <div class="event-detail ms-sm-3 mt-sm-0 mt-4">
                                    <h6 class="text-sm-start text-center">{{ __('messages.vcard.job_title') }}</h6>
                                    <h5 class="event-name mb-0" style="word-break: keep-all;">{!! ucwords($vcard->job_title) !!}</h5>
                                </div>
                            </div>
                        </div>
                    @endif
	    ...
	    <div class="vcard-nine__qr-code py-4 px-3 position-relative px-sm-3 mb-10 mt-0">
		    ...
		    <div class="container mt-5">
			    <div class="card qr-code-card flex-sm-row flex-column justify-content-center align-items-center mt-3 border-0">
				    <div class="qr-code-scanner mx-md-4 mx-2 p-4 bg-white qr-code-image d-flex justify-content-around align-itmes-center">
        ...
        @if(checkFeature('gallery') && $vcard->gallery->count())
            <div class="vcard-nine__gallery py-4 px-3 position-relative px-sm-3 mb-10 mt-0">
                <h4 class="heading-right heading-line position-relative text-center">{{ $galleryName }}</h4>
                <div class="container">
