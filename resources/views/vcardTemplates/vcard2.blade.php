...
<div class="container p-0">
    ...
    <div class="vcard-two main-content w-100 mx-auto overflow-hidden content-blur collapse show allSection">
        ...
        <div class="vcard-two__profile position-relative">
            <div class="avatar position-absolute top-0 translate-middle mx-10">
                <img src="{{ $vcard->profile_url }}" alt="profile-img" class="rounded-circle"/>
            </div>
        </div>
        {{--profile details--}}
        <div class="vcard-two__profile-details py-3 px-3 mx-10">
            <h4 class="vcard-two-heading">
                {{ ucwords($vcard->first_name.' '.$vcard->last_name) }}
            </h4>
            <span class="profile-designation" style="display: inline-block; width: 345px; word-break: keep-all:">{{ ucwords($vcard->occupation) }}</span>
            <span class="profile-description d-flex pt-4" style="width: 420px; word-break: keep-all:"> {!! $vcard->description !!}</span>
        ...
        {{--event--}}
        <div class="vcard-two__event py-3 px-3 mx-10" style="word-break: keep-all;">
            @if($vcard->email)
            ...
            @if($vcard->job_title)
                <div class="event-details d-flex">
                    <div class="event-image">
                        <img src="{{asset('assets/img/vcard2/job_title.png')}}" alt="job" style="width: 27px;"/>
                    </div>
                    <span>{!!  $vcard->job_title !!}</span>
                </div>
            @endif
        </div>
	    {{--qr code--}}
        ...
        @if(checkFeature('gallery') && $vcard->gallery->count())
            <div class="vcard-two__gallery mt-3 py-3 position-relative px-3 mb-10 mt-0">
                <h4 class="vcard-two-heading text-center pb-4">{{ $galleryName }}</h4>
                <div class="container">
