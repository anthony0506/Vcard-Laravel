        ...
        <div class="vcard-eight__profile d-flex align-items-center px-4 flex-sm-row flex-column position-relative">
            ...
            <div class="vcard-eight__position d-flex flex-column mx-4 position-relative">
                <div class="d-flex flex-column">
                    ...
                    <span class="avatar-designation text-white text-sm-start text-center" style="word-break: keep-all:">{{ ucwords($vcard->occupation) }}</span>
                </div>
            </div>
        </div>
    ...
    @if($vcard->email || $vcard->phone || $vcard->dob || $vcard->location ||$vcard->alternative_email )
                    ...
                    <div class="card event-card p-4">
                        <div class="row g-4">
                            ...
                            @if($vcard->job_title)
                                <div class="col-sm-6 col-12">
                                    <div class="event-icon rounded-circle d-flex justify-content-center align-items-center mx-auto mb-2">
                                        <img src="{{asset('assets/img/vcard8/job_title.png')}}" alt="job" style="width: 25px;"/>
                                    </div>
                                    <div class="event-details">
                                        <span class="text-white text-center d-block mb-1">{{ __('messages.vcard.job_title') }}</span>
                                        <h5 class="text-center mb-0 text-white">{!! ucwords($vcard->job_title) !!}</h5>
                                    </div>
                                </div>
                            @endif
                        </div>
	    ...
	    <div class="vcard-eight__qr-code py-4 position-relative px-sm-4 px-3">
		    ...
		    <div
			    ...
			    <div class="mt-3 qr-code-scanner mx-md-4 mx-2 pb-2 bg-white qr-code-image d-flex justify-content-around align-itmes-center">
        ...
        @if(checkFeature('services') && $vcard->services->count())
            <div class="vcard-eight__service py-4 position-relative px-sm-4 px-3 mb-0 mt-0">
                <div class="container">
        ...
        @if(checkFeature('gallery') && $vcard->gallery->count())
                <div class="vcard-eight__gallery py-4 position-relative px-sm-4 px-3 mb-0 mt-0">
                    <h4 class="vcard-eight-heading heading-line position-relative text-center d-block mx-auto pb-3">{{ $galleryName }}</h4>
        ...
        @if(checkFeature('products') && $vcard->products->count())
            <div class="vcard-eight__product py-4 position-relative px-sm-4 px-3 mb-5 mt-0">
        ...
        @if(checkFeature('testimonials') && $vcard->testimonials->count())
            <div class="vcard-eight__testimonial py-4 position-relative px-sm-4 px-3 mb-5 mt-0">
                <h4 class="vcard-eight-heading heading-line position-relative text-center d-block mx-auto pb-3">
        ...
        @if(checkFeature('blog') && $vcard->blogs->count())
            <div class="vcard-eight__blog position-relative py-0 mb-5 mt-0">
                <h4 class="vcard-eight-heading heading-line position-relative text-center d-block mx-auto pb-3">
                    {{ __('messages.feature.blog') }}</h4>
                <div class="container">
                    <div class="row g-4 blog-slider overflow-hidden" style="margin-bottom: 0px;">
